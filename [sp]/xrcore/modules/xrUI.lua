...
function UIWindow.new ( x, y, width, height, titleBarText, relative, pattern )
	local wnd = {
		type = "wnd",
	...
	wnd.frame = UIFrame.new ( x, y, width, height, 
		pattern or ui_frame_03 -- Default
	)
...
function UIWindow:draw ( )
	...
	dxDrawText ( self.text, self.x, self.y, self.x + 256, self.y, _textColor, self.textScale * xrUI.textScaleFactor, self.font, "center", "center" )
...
function UIEdit:draw ( )
	...
	dxDrawText ( text, self.x + 10, self.y, 0, self.y + self.height, _textColor, self.textScale * xrUI.textScaleFactor, self.font, "left", "center" )
end
...
function UIButton:draw ( )
	...
	dxDrawText ( self.text, self.x, self.y, self.x + self.width, self.y + self.height, self.selected and _textHColor or _textColor, self.textScale * xrUI.textScaleFactor, self.font, "center", "center" )
end
...
function UILabel:draw ( )
	...
	dxDrawText ( self.text, self.x, self.y, self.x + self.width, self.y + self.height, _textColor, self.textScale * xrUI.textScaleFactor, self.font, self.alignment and "center" or "left", "top", false, self.wordBreak == true )
end
...
function UIListItem:draw ( x, y, width )
	-- TODO
	dxDrawText ( self.text, x + 10, y, 0, y + 50, _textColor, self.textScale * xrUI.textScaleFactor, self.font, "left", "center" )
end
