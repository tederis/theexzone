	...
	if self.rankShowTime then
		...
		if randIndex > 0 then
			...
			if rankTexSection then
				...
				rankTexSection:draw( self.tex, x - iconWidth*1.5, y + height / 2 - iconHeight / 2, iconWidth, iconHeight, 0, 0, 0 )
			end
		end
		...
		if randIndex <= 4 then
			...
			if rankTexSection then
				local iconWidth = iconHeight * ( rankTexSection.width / rankTexSection.height )
				rankTexSection:draw( self.tex, x + width + iconWidth*0.5, y + height / 2 - iconHeight / 2, iconWidth, iconHeight, 0, 0, 0 )
			end		
		end
